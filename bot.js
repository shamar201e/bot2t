...
client.on('message', message => {
    ...
    if(message.content.startsWith(`${prefix}ban`)){
        ...
        reason = reason.replace('2', "**نشر في العام**");
        reason = reason.replace('3', "**سب في الشات**");
        reason = reason.replace('4', "**سبام**");
        reason = reason.replace('5', "**استهبال**");
        var embed = new Discord.RichEmbed()
...
client.on("guildMemberAdd", member => {
  client.channels.find('id', '592417337362350110').send(` **Welcome To New York SHOP **  `)
});
/////////
